...
class _HomePageState extends State<HomePage> with SingleTickerProviderStateMixin {
      ...
      child: Stack(
        ...
        children: [
          ...
          Column(
            ...
            children: [_circularAnimationButton(),
            _starIcon()]
            ),
        ],
      ),
      ...
      child: GestureDetector(
        onTap: () {
          setState(() {
            ...
            _buttonRadius == 100 ? (_text = "Expand!") : (_text = "Shrink!");
          });
        },
  ...
  Widget _starIcon(){
    return AnimatedBuilder(animation: _starIconAnimationController!.view,
    builder: (_buildContext, _child){
      return Transform.rotate(angle: _starIconAnimationController!.value*2*pi, child: _child);
    },
